...
Çalıştırma: python3 train_demand_model.py   (aynı klasörde iki CSV olmalı)
"""
...
pred_nn = net.predict([Xte, bte], verbose=0).ravel()
...
print('model + sonuçlar kaydedildi: demand_model.keras, model_results.json')
